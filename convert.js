...
function CurrConv(source, valnum8) {
    ...
    if (source == "dol") {
        rup.value = (valnum8 * 82.93).toFixed(2);
        pou.value = (valnum8 * 0.89).toFixed(2);
        eur.value = (valnum8 * 1.02).toFixed(2);
    }
    if (source == "pou") {
        rup.value = (valnum8 * 93.34).toFixed(2);
        dol.value = (valnum8 * 1.13).toFixed(2);
        eur.value = (valnum8 * 1.15).toFixed(2);
    }
    if (source == "eur") {
        rup.value = (valnum8 * 81.24).toFixed(2);
        dol.value = (valnum8 * 0.98).toFixed(2);
